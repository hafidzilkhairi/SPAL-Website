    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url().'admin'; ?>"><img src="<?php echo base_url(); ?>images/logo.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="<?php echo base_url().'admin'; ?>"><img src="<?php echo base_url(); ?>images/logo2.png" alt="Logo"></a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="<?php echo base_url(); ?>admin/produk">Manajemen Produk</a></li>
                            <li><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>admin/produk/tambah">Tambah Produk</a></li>
                        </ul>
                    </li>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="<?php echo base_url();?>admin/signOut"><i class="fa fa-power-off"></i> Logout</a>
                        </div>
                    </div>
