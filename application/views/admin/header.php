                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="<?php echo base_url(); ?>admin">Manajemen Produk</a></li>
                            <li><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>admin/tambahProduk">Tambah Produk</a></li>
                        </ul>
                    </li>
